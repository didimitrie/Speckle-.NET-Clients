...
{
    public class AbstractSender : GH_Component, IGH_VariableParameterComponent
    {
        string streamId;
        ...
        public AbstractSender()
          : base("AbstractSender", "AbstractSender",
              "Abstract data sender",
        ...
        public List<object> getData()
        {
            ...
            foreach (IGH_Param myParam in Params.Input)
            {
                foreach( object o in myParam.VolatileData.AllData(true))
                data.Add(o);
            }
            return data;
        }
